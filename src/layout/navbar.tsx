...
export default function Navbar(props: NavbarProps) {
  ...
  return (
    <>
      {/* <div className="fixed top-5 mt-2 px-6 py-2 sm:mt-8 sm:px-14 md:px-20 lg:absolute"> */}
      <div className="absolute top-5 mt-2 px-6 py-2 sm:mt-8 sm:px-14 md:px-20">
      ...
      <header className="sticky top-0 z-50 mt-2 px-6 py-8 sm:mt-8 sm:px-14 md:px-20">
        <div className="mx-auto flex items-center justify-end lg:max-w-7xl">
          {/* <div></div> */}
